...
class TasksController extends Controller {
    ...
    {
        return view('tasks.index', compact('catagory'));
    }
    ...
    public function store(Catagory $catagory)
    {
        ...
        //return Redirect::route('catagories.show1', $catagory->id)->with('Task created.');
    ...
    public function update(Catagory $catagory, Task $task)
    {
        ...
        //return Redirect::route('catagories.show1', [$catagory->id, $task->catagory_id])->with('message', 'Task updated.');
    ...
    public function destroy(Catagory $catagory, Task $task)
    {
        ...
        return Redirect::route('catagories.show', $catagory->id)->with('message', 'Task deleted.');
        //return Redirect::route('catagories.show1', $catagory->id)->with('message', 'Task deleted.');
